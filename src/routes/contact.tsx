  ...
  head: () => ({
    meta: [
      { title: "Contact — Tanusiya Choudhury" },
      {
        name: "description",
        content:
          "Inquire about collaborations, performances, and media opportunities with Tanusiya Choudhury.",
      },
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <Reveal delay={0.2}>
            <p className="mx-auto mt-6 max-w-xl text-muted-foreground">
              Collaboration inquiries, performance bookings, brand partnerships, or just to say
              hello. Every message is read and responded to with care.
            </p>
          </Reveal>
        </div>
      </section>
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <Field
                    label={type === "collab" ? "Brand / Company" : "Venue / Event"}
                    name="org"
                  />
            ...
            <aside className="space-y-4">
              <div className="glass rounded-3xl p-6">
                ...
                <a
                  ...
                  className="mt-3 flex items-center gap-2 sm:gap-3 font-display text-sm sm:text-xl lg:text-2xl break-all"
                >
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <a
                      key={l}
                      href="#"
                      className="group flex items-center gap-3 rounded-xl border border-white/5 bg-white/5 p-4 transition hover:border-primary/40 hover:bg-primary/10"
                    >
              ...
              <div className="glass rounded-3xl p-6">
                <p className="font-serif text-xl italic leading-relaxed">
                  "Every great collaboration starts with a conversation and a shared vision."
                </p>
              </div>
            </aside>
          </Reveal>
