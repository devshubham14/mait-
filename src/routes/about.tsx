  ...
  head: () => ({
    meta: [
      { title: "About — Luna Aria" },
      {
        name: "description",
        content:
          "A documentary chapter about Luna Aria — childhood dreams, the discovery of music and dance, and the artist she became.",
      },
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <Reveal>
            <p className="text-xs uppercase tracking-[0.4em] text-primary">
              A documentary in five chapters
            </p>
          </Reveal>
          <Reveal delay={0.1}>
          ...
          <Reveal delay={0.3}>
            <p className="mx-auto mt-8 max-w-2xl text-lg text-muted-foreground">
              This isn't a biography. It's a film, paused between heartbeats — the small, cinematic
              moments that shaped a singer, dancer, and storyteller.
            </p>
          </Reveal>
        </div>
      </section>
    ...
    <div className="grid items-center gap-12 py-24 md:grid-cols-2 md:gap-20">
      ...
      <Reveal y={60} delay={0.1}>
        <div>
          ...
          <h3 className="mt-4 font-display text-3xl sm:text-4xl tracking-tight md:text-6xl">
            {chapter.title}
          </h3>
